...
define("ProjectName","canedu");
	//Access Control Setting
//if(($_SESSION['UN']=="")||(!in_array("FileManager",$_SESSION['Permission'])))
if(($_SESSION[ProjectName.'Username']==""))
                {
	...
	define('CONFIG_WEBSITE_DOCUMENT_ROOT', '/upload');	
	define('CONFIG_WEBSITE_ROOT_ADDRESS', '/upload/');	
