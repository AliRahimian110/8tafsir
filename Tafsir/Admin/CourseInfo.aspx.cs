        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    txtNumberCourse.Value = objEntity.NumberCourse;
                    txtVAHED.Value = objEntity.Vahed.ToString();
                    txtTypeCourse.Value = objEntity.TypeCourse.ToString();
                    txtTitle.Value = objEntity.Title;
                    txtDateStart.Value = objEntity.DateStart;
                    txtTimeCourse.Value = objEntity.TimeCourse;
                    txtTimeQuiz.Value = objEntity.TimeQuiz;
                    txtLength.Value = objEntity.Length;
                    txtAddress.Value = objEntity.Address;
                    txtTeacher.SelectedValue = objEntity.TeacherId.ToString();
