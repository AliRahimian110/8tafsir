<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPage.Master" AutoEventWireup="true" CodeBehind="CourseList.aspx.cs" Inherits="Tafsir.Admin.CourseList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
    <div style="width: 95%; margin-right: 2.5%; margin-left: 2.5%; overflow: hidden;">
        <h2 class="speratorLine">
            <p runat="server" id="TxtType">دروس</p>
        </h2>
        <div class="innerBox">
                ...
                <asp:ListView ID="ListView1" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="ItemInList"><%#Eval("Title")%></td>
                            <td class="ItemInList"><%#Eval("Length")%></td>
                            <td class="ItemInList"><%#Eval("TimeCourse")%></td>
