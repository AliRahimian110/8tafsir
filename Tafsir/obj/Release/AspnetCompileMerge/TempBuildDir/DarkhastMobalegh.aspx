                    ...
                    <tr>
                        <td>
                            ...
                            <div runat="server" id="bodydiv" class="register_form">
                                <h3>درخواست مبلغ</h3>
                                <p>در صورت نیاز به مبلغ قرآنی لطفاً فرم زیر را پر کنید و دکمه ارسال را بفشارید، ما در اسرع وقت با شما تماس خواهیم گرفت</p>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 form_group">
                                        ...
                                        <input runat="server" id="txttel" name="tel" placeholder="شماره تماس" pattern="0[1-9]{10}" required="" type="tel" style="text-align: left" /><br />
