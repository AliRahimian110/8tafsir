                                        ...
                                        <table style="width: 90%; margin-right: 1%;" dir="rtl">
                                            <tr>
                                                ...
                                                <td style="text-align:right">
                                                    <input runat="server" id="txtFirstName" name="FirstName" placeholder="نام" required="" type="text" /></td>
                                            </tr>
                                            <tr>
                                                <td>نام خانوادگی :</td>
                                                <td style="text-align:right">
                                                    <input runat="server" id="txtLastName" name="LastName" placeholder="نام خانوادگی" required="" type="text" /></td>
                                            </tr>
                                            <tr>
                                                <td>تاریخ تولد :</td>
                                                <td style="text-align:right">
                                                    <input runat="server" id="txtBirthDate" name="BirthDate" placeholder="تاریخ تولد" required="" type="text" class="pdate" /><script type="text/javascript">var objCal1 = new AMIB.persianCalendar('ContentPlaceHolder1_txtBirthDate');</script></td>
                                            </tr>
                                            <tr>
                                                <td>شماره تماس</td>
                                                <td style="text-align:right">
                                                    <input runat="server" id="txtTel" name="Tel" placeholder="شماره تماس" pattern="0[1-9]{10}" required="" type="tel" style="text-align: left; direction: ltr;" /></td>
                                            </tr>
                                            <%--<tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td style="text-align:right">
                                                    <asp:button runat="server" id="butSend" onclick="butSend_OnClick" text="ارسال" width="50px" />
                                                </td>
                                            </tr>
                                        </table>
