            ...
            <div class="">
                <div class=" form_group"><br/>
                    ...
                    <table style="width: 95%;" dir="rtl">
                        ...
                        <tr><td align="left">شناسه:&nbsp;</td><td><input runat="server" id="txtId" name="name" readonly="readonly" required="" type="text" size="100" maxlength="100" /><br />
                        </td></tr>
                        <tr><td align="left">فعال :</td><td><input type="checkbox" runat="server" id="txtChecked"/>
                        </td></tr>                                              
                        <tr><td align="left">    عنوان:&nbsp;</td><td><textarea runat="server" id="txtTitle" name="name" rows="2" type="text" style="width: 85%" maxlength="400"></textarea><br />
                        </td></tr>
                         <tr><td align="left"> آدرس:</td><td>
